...
SECRET_KEY = 'w==(qjnhu#o^+)h78fbx0uwc=+qw(hpcoo^vm3#ayc=8#1g5l^'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'hackernews',#'djzdqtgu',
        'USER': 'postgres',#'djzdqtgu',
        'PASSWORD': 'OneKeyDB',#'BCzrgKJG5hTCJp9a7iG9Gd97blnBo7c4',
